...
local theme = lush(function()
  return {
    ...
    LspDiagnosticsDefaultError           { fg = colors.red.lighten(30) }, -- Used as the base highlight group. Other LspDiagnostic highlights link to this by default (except Underline)
    LspDiagnosticsDefaultWarning         { fg = colors.orange.lighten(30) }, -- Used as the base highlight group. Other LspDiagnostic highlights link to this by default (except Underline)
    LspDiagnosticsDefaultInformation     { fg = colors.fg.lighten(30) }, -- Used as the base highlight group. Other LspDiagnostic highlights link to this by default (except Underline)
    LspDiagnosticsDefaultHint            { fg = colors.blue.lighten(30) }, -- Used as the base highlight group. Other LspDiagnostic highlights link to this by default (except Underline)
    ...
    LspDiagnosticsSignError              { LspDiagnosticsDefaultError, gui = "bold" }, -- Used for "Error" signs in sign column
    LspDiagnosticsSignWarning            { LspDiagnosticsDefaultWarning, gui = "bold" }, -- Used for "Warning" signs in sign column
    LspDiagnosticsSignInformation        { LspDiagnosticsDefaultInformation, gui = "bold" }, -- Used for "Information" signs in sign column
    LspDiagnosticsSignHint               { LspDiagnosticsDefaultHint, gui = "bold" }, -- Used for "Hint" signs in sign column
